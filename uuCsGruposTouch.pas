...
type
  TfrmCsGruposTouch = class(Tfrm_modelo_pesquisas)
...
procedure TfrmCsGruposTouch.DBGrid1DrawColumnCell(Sender: TObject;
...
procedure TfrmCsGruposTouch.FormActivate(Sender: TObject);
begin
  inherited;
  dm.qry_consultas.Active:=false;
  dm.qry_consultas.sql.clear;
  dm.qry_consultas.sql.add(' select * from grupos_touch order by codigo');

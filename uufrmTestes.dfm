inherited frmSincronizarBase: TfrmSincronizarBase
  ClientHeight = 370
  ClientWidth = 562
  ExplicitWidth = 578
  ExplicitHeight = 409
  ...
  object Panel1: TPanel [4]
    ...
    object lblTitulo: TLabel
      ...
      Height = 29
      AutoSize = False
      Caption = 'Sincroniza'#231#227'o  da base de dados'
      Font.Charset = ANSI_CHARSET
      Font.Color = clWhite
      Font.Height = -24
      Font.Name = 'Calibri'
  ...
  object Panel2: TPanel [5]
    ...
    DesignSize = (
      562
      62)
    object btSincronizar: TAdvGlassButton
      Left = 288
      Top = 4
      Width = 123
      Height = 55
  ...
  object Panel3: TPanel [6]
    ...
    object lbStatus: TLabel
      ...
      Width = 505
      Height = 29
      Caption = 'Clique em iniciar para come'#231'ar a sincroniza'#231#227'o'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -24

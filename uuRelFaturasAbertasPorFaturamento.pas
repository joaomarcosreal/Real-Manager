unit uuRelFaturasAbertasPorFaturamento;
...
type
  TfrmRelFaturasAbertasPorFaturamento = class(Tfrm_modelo_vazio)
...
procedure TfrmRelFaturasAbertasPorFaturamento.BitBtn2Click(
  Sender: TObject);
begin
  inherited;
  close;
...
function TfrmRelFaturasAbertasPorFaturamento.verificaValidade() : boolean;
begin
  Result:=false;
...
procedure TfrmRelFaturasAbertasPorFaturamento.emitirRelatorio();
begin
  ...
  dm_relatorios.rpt.LoadFromFile(patchAplicacao+'relatorios\relatorioFaturasEmAbertoPorFaturamento.fr3',true);
...
procedure TfrmRelFaturasAbertasPorFaturamento.BitBtn1Click(
  Sender: TObject);
begin
  inherited;
...
procedure TfrmRelFaturasAbertasPorFaturamento.FormActivate(
  Sender: TObject);
begin
  inherited;
...
procedure TfrmRelFaturasAbertasPorFaturamento.rdTipoPeriodoClick(
  Sender: TObject);
begin
  inherited;

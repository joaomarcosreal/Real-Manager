...
uses
  ...
  Dialogs, uu_modelo_Vazio, ExtCtrls, StdCtrls, Buttons, Mask,ogutil,
  jpeg, JvActionsEngine, JvControlActions, Vcl.ActnList, System.Actions,
...
begin
  ...
  if verificaLicencaValida then
   begin
     dm.gravaini('BANCO_DE_DADOS','registro_'+codEmpresa ,dm.criptografa(edLicenca.Text,'1320'));

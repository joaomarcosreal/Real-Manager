inherited frmConfirmaCancelamentoPlataformas: TfrmConfirmaCancelamentoPlataformas
  ClientHeight = 360
  ClientWidth = 535
  ExplicitWidth = 551
  ExplicitHeight = 399
  ...
  object pnTitulo: TPanel [2]
    ...
    object lbTitulo: TLabel
      ...
      Height = 32
      AutoSize = False
      Caption = 'Informe as raz'#245'es do cancelamento'
  ...
  object Panel2: TPanel [4]
    ...
    object cbMotivo: TComboBox
      ...
      Items.Strings = (
        ...
        'ITEM INDISPON'#205'VEL'
        'RESTAURANTE SEM MOTOBOY'
        'CARD'#193'PIO DESATUALIZADO'
        'PEDIDO FORA DA '#193'REA DE ENTREGA'
        'CLIENTE GOLPISTA / TROTE'
        'FORA DO HOR'#193'RIO DO DELIVERY'
        'DIFICULDADES INTERNAS DO RESTAURANTE'
        #193'REA DE RISCO'
        'RESTAURANTE ABRIR'#193' MAIS TARDE'
        'RESTAURANTE FECHOU MAIS CEDO')
    end

...
uses
  ...
  acbrutil, System.Generics.Collections, uuRealDialog, RealFramework, Dialogs,
  ...
  cxLookupEdit, cxDBLookupEdit, RxToolEdit, JvPageList, JvExControls, sCheckBox;
...
type
  TfrmCadProdutos = class(Tfrm_modelo_vazio)
    ...
    pgDadosProdutos: TJvStandardPage;
    Panel7: TPanel;
    Label6: TLabel;
    Panel8: TPanel;
    Label41: TLabel;
    ...
    Label13: TLabel;
    cbLocalImpressaoComanda: TcxLookupComboBox;
    Label23: TLabel;
    imgCheckBoxes: TImageList;
    ckbEstoca: TsCheckBox;
    ckbVende: TsCheckBox;
    sCheckBox4: TsCheckBox;
    ckbSubproduto: TsCheckBox;
    ...
    procedure edCodBarrasKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
...
function TfrmCadProdutos.controla_botoes(botao: TBitBtn): boolean;
begin
...
begin
  ...
  cbLocalImpressaoComanda.EditValue := '001';
...
{ if trim(ed_cod_barras.text) = '' then
  ...
  begin
    ...
    dm.qryauxiliar.active := false;
    dm.qryauxiliar.sql.clear;
    dm.qryauxiliar.sql.add('select * from produtos where cod_barras=' + Quotedstr(edCodBarrasProduto.Text) + ' and cod_produto <> ' + Quotedstr(edCodProduto.Text));
    dm.qryauxiliar.Active := true;
...
begin
  ...
  descricao := QuotedStr(trim(EdDescricaoProduto.Text));
...
//  caminho_foto:=QuotedStr('c:\restaurante\imagens\semfoto.jpg');
  ...
  cod_miniPrinter := Quotedstr(cbLocalImpressaoComanda.EditValue);
  ...
  case oquefazer of
      ...
      begin
        ...
        begin
          if trim(edCodBarrasProduto.Text) = '' then
            ...
            cod_barras := Quotedstr(Trim(edCodBarrasProduto.Text));
        end;
    ...
    2:
      begin
        cod_barras := edCodBarrasProduto.Text;
        string_auxiliar := edCodProduto.Text;
        dm.qryauxiliar.Active := false;
        dm.qryauxiliar.SQL.Clear;
...
begin
  ...
  EdDescricaoProduto.Text := dm.qryauxiliar.fieldbyname('descricao').value;
...
begin
  ...
  try
    cbLocalImpressaoComanda.EditValue := dm.qryauxiliar.fieldbyname('cod_miniprinter').value;
  except
  end;
  ...
  try
    edCodBarrasProduto.Text := dm.qryauxiliar.fieldbyname('cod_barras').value;
  except
  end;
  try
...
begin
  ...
  begin
    ...
    begin
      ...
      frm_cad_itens_estoque.setCodgrupoDescricao(self.ed_cod_grupo.Text, self.EdDescricaoProduto.Text);
...
procedure TfrmCadProdutos.edCodBarrasKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  inherited;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        cbGrupoTouch.EditValue := '01';
        ckbVende.Checked := true;
        EdDescricaoProduto.Text := 'PIZZA ' + memoSabores.Lines[i];
        EdDescricaoProduto.Text := EdDescricaoProduto.Text + ' BT';
        ckbPizza.Checked := true;
        rdTamanhoPizza.ItemIndex := 0;
      ...
      begin
        ...
        ckbVende.Checked := true;
        EdDescricaoProduto.Text := 'PIZZA ' + memoSabores.Lines[i];
        EdDescricaoProduto.Text := EdDescricaoProduto.Text + ' PQ';
        ckbPizza.Checked := true;
        rdTamanhoPizza.ItemIndex := 1;
      ...
      begin
        ...
        ckbVende.Checked := true;
        EdDescricaoProduto.Text := 'PIZZA ' + memoSabores.Lines[i];
        EdDescricaoProduto.Text := EdDescricaoProduto.Text + ' MD';
        ckbPizza.Checked := true;
        rdTamanhoPizza.ItemIndex := 2;
      ...
      begin
        ...
        ckbVende.Checked := true;
        EdDescricaoProduto.Text := 'PIZZA ' + memoSabores.Lines[i];
        EdDescricaoProduto.Text := EdDescricaoProduto.Text + ' GD';
        ckbPizza.Checked := true;
        rdTamanhoPizza.ItemIndex := 3;
      ...
      begin
        ...
        ckbVende.Checked := true;
        EdDescricaoProduto.Text := 'PIZZA ' + memoSabores.Lines[i];
        EdDescricaoProduto.Text := EdDescricaoProduto.Text + ' FM';
        ckbPizza.Checked := true;
        rdTamanhoPizza.ItemIndex := 4;

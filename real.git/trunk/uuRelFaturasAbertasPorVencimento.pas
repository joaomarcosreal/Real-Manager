...
begin
  ...
  dm_relatorios.qryFaturasAbertas.sql.add('    where status=0 and f.data_fatura between '+Quotedstr(FormatDateTime('DD.MM.YYY',edDataInicial.Date))+' and '+Quotedstr(FormatDateTime('DD.MM.YYY',edDataFinal.Date)));
  if (  trim(ed_cod_cliente.Text) <> '') then
   begin

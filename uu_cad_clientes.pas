...
uses
  ...
  ACBrValidador, uu_modelo, StdCtrls, DBCtrls, Buttons, Mask, ExtCtrls, Dialogs;
...
uses
  uu_data_module, uu_modelo_vazio, uu_frm_principal, Math;
...
begin
  ...
  try
    begin
      ...
      if ((dm.qry_clientesCGC_CPF.Value <> null) and (trim(dm.qry_clientesCGC_CPF.Value)<> '')) then
      begin

object frm_relatorio_caixa: Tfrm_relatorio_caixa
  Left = 300
  Top = 162
  Width = 516
  Height = 193
  ...
  object Panel4: TPanel
    ...
    object cb_tipo_relatorio: TComboBox
      ...
      Items.Strings = (
        ...
        'Apenas usu'#225'rio selecionado')
    end
    object cb_usuario: TDBLookupComboBox
      Left = 197
      Top = 80
      Width = 169
      Height = 21
      KeyField = 'COD_USUARIO'
    ...
    object ckb_filtro_horas: TCheckBox
      Left = 272
      Top = 56
      Width = 153
      Height = 17
      Caption = 'Usar filtro de horas'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'MS Sans Serif'
    ...
    object ckb_importadas: TCheckBox
      Left = 370
      Top = 81
      Width = 119
      Height = 17

inherited frmRelSangrias: TfrmRelSangrias
  ClientHeight = 288
  ClientWidth = 380
  ExplicitWidth = 396
  ExplicitHeight = 327
  ...
  object Panel1: TPanel [2]
    ...
    object Label1: TLabel
      ...
      Width = 201
      Height = 24
      Caption = 'Relat'#243'rio de Sangrias'
  ...
  object Panel2: TPanel [3]
    ...
    object cbTipoSangria: TcxLookupComboBox
      Left = 11
      Top = 93
      ParentFont = False
      ...
      Properties.ListSource = dm.dsQryTiposSangria
    ...
    object rdTipoAgrupamento: TRadioGroup
      Left = 236
      Top = 125
      Width = 129
      Height = 53

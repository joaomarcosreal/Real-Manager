...
begin
  ...
  dm.qry_consultas.sql.add(' where f.razao_social like ' + Quotedstr('%' + ed_parametro.text + '%'));
  dm.qry_consultas.sql.add(' or f.nome_fantasia like' + Quotedstr('%' + ed_parametro.text + '%'));
...
procedure Tfrm_cs_fornecedores.DBGrid1DrawColumnCell(Sender: TObject; const Rect: TRect; DataCol: Integer; Column: TColumn; State: TGridDrawState);
begin
  inherited;

...
type
  TfrmCsCSTPISCOFINS = class(Tfrm_modelo_pesquisas)
    Label2: TLabel;
...
procedure TfrmCsCSTPISCOFINS.FormActivate(Sender: TObject);
begin
  inherited;
  dm.qry_consultas.Active:=false;
  dm.qry_consultas.sql.Clear;
  dm.qry_consultas.sql.add('select * from CST_PIS_COFINS order by CST');
  dm.qry_consultas.Active:=true;

end;

procedure TfrmCsCSTPISCOFINS.DBGrid1DrawColumnCell(Sender: TObject;

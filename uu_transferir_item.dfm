object frm_transferir_item: Tfrm_transferir_item
  Left = 206
  Top = 63
  BorderIcons = []
  BorderStyle = bsSingle
  BorderWidth = 1
  Caption = 'Transfer'#234'ncia de produto'
  ClientHeight = 452
  ClientWidth = 868
  Color = clBtnFace
  ...
  object Panel3: TPanel
    ...
    object Panel5: TPanel
      ...
      object ed_mesa_destino: TEdit
        ...
        ParentFont = False
        TabOrder = 0
        OnExit = ed_mesa_destinoExit
        OnKeyDown = ed_mesa_destinoKeyDown
      end
    end

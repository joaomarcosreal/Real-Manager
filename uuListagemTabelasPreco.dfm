inherited frmListagemTabelasPreco: TfrmListagemTabelasPreco
  ...
  object Panel2: TPanel [4]
    ...
    object Label1: TLabel
      ...
      Width = 333
      Height = 20
      Caption = 'Selecione as tabelas que deseja imprimir:'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -16
    ...
    object cbkExibirPercentuais: TCheckBox
      Left = 6
      Top = 76
      Width = 340
      Height = 17
      Caption = 'Exibir percentuais de reajuste dos pre'#231'os'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -16
      Font.Name = 'MS Sans Serif'
    ...
    object cbTabelaPreco: TcxCheckComboBox
      Left = 5
      Top = 30
      ParentFont = False

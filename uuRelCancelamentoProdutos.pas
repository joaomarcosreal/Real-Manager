...
uses
  ...
  Vcl.StdCtrls, Vcl.ExtCtrls, Vcl.Buttons, JvSpin, JvExMask, JvActionsEngine,
...
uses uuDmRelatorios, uu_frm_principal, uu_data_module;
...
begin
 ...
 dRelatorios.qryRelEstornos.SQL.Add(' select upper( udf_monthname(c.data_sistema)) ||'+Quotedstr('/')+'|| udf_year(c.data_sistema) mes, ');
 dRelatorios.qryRelEstornos.SQL.Add('  c.codigo,c.data_sistema, e.hora,c.nome_usuario,e.nome_usuario_autorizou, c.numero_caixa, e.descricao,obs, me.descricao as descMotivo,');
 ...
 dRelatorios.qryRelEstornos.SQL.Add('  from  estornos e');
   dRelatorios.qryRelEstornos.SQL.Add(' inner join motivos_estornos me on (me.codigo = e.cod_motivo) ');

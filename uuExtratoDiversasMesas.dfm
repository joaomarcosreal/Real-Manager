inherited frmExtratoDiversasMesas: TfrmExtratoDiversasMesas
  Caption = 'Pr'#233'-conta  ( Diversas mesas)'
  ClientHeight = 365
  ClientWidth = 349
  ExplicitWidth = 365
  ExplicitHeight = 404
  ...
  object Panel2: TPanel [3]
    ...
    object ckbTodasAsMesas: TcxCheckBox
      Left = 2
      Top = 99
      Caption = 'Todas as mesas'
      ParentFont = False
      Style.Font.Charset = DEFAULT_CHARSET
      Style.Font.Color = clWindowText
